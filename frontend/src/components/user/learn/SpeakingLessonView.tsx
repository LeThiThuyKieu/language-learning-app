...
export default function SpeakingLessonView({
    ...
    const lines = useMemo(() => splitLines(q?.correctAnswer || q?.questionText), [q?.correctAnswer, q?.questionText]);
    ...
    // Tạm thời luôn “đúng” sau khi check (STT/AI sẽ làm sau)
                ...
                <div className="w-full max-w-4xl mx-auto px-4 md:px-8 pt-10 pb-28">
                    ...
                    <div className="mt-10 rounded-2xl border-2 border-gray-200 bg-white p-5 md:p-6 shadow-sm">
                                ...
                                return (
                                    <div
                                        ...
                                        className={[
                                            ...
                                            active && !checked ? "border-primary-500 bg-primary-50 ring-2 ring-primary-200" : "border-gray-200",
                                            checked ? "opacity-80" : "",
                                        ].join(" ")}
                                    >
                        ...
                        <div className="mt-4 text-xs text-gray-500">
                            (Tạm thời chỉ UI. Phần Speech-to-Text và chấm điểm % sẽ làm sau.)
                        </div>
                    </div>
                </div>
