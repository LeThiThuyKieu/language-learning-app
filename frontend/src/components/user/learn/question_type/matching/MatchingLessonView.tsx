...
/** Sao nhỏ kiểu Duolingo khi ghép đúng cặp */
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
            ...
            <main className="flex-1 w-full">
                <div className="w-full max-w-4xl mx-auto px-4 md:px-8 pt-8 pb-28">
                    ...
                    <span
                        className={`relative z-[1] h-8 w-8 shrink-0 rounded-lg border flex items-center justify-center text-xs font-bold transition-colors ${
                            isSelected ? "bg-white border-primary-200 text-primary-600" : "bg-gray-50 border-gray-100 text-gray-400"
                        }`}>
                      {idx + 1}
                    </span>
                                        <span
                                            className={`relative z-[1] text-base font-semibold ${isMatched ? "text-gray-400" : "text-gray-800"}`}>
                      {p.left}
                    </span>
                                    </button>
                                );
                        ...
                        <div className="space-y-3">
                            {rightItems.map((r, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        {isJustMatched && <CorrectPairSparkles/>}
                    <span className={`relative z-[1] text-base font-semibold ${isMatched ? "text-gray-400" : "text-gray-800"}`}>
                      {r.text}
                    </span>
                                        <span
                                            className="relative z-[1] h-8 w-8 shrink-0 rounded-lg border border-gray-100 bg-gray-50 flex items-center justify-center text-xs font-bold text-gray-400">
                      {idx + 1}
                    </span>
                                    </button>
                                );
