...
function ReviewSidebarItem({
  ...
  function handleMouseEnter() {
    if (isUnlocked || !btnRef.current) return;
  ...
  return (
    <div className="relative w-full">
      ...
      {/* Tooltip qua portal — thoát khỏi mọi stacking context */}
      {!isUnlocked && tooltipStyle &&
        createPortal(
          <div
            style={tooltipStyle}
            className="pointer-events-none flex items-center gap-1.5 whitespace-nowrap rounded-xl bg-gray-900 px-3 py-2 text-xs font-semibold text-white shadow-lg
